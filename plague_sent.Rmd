...
```{r}
plague %>% group_by(part) %>% freq(nrc_sent)
```
...
```{r}
love_freq <-plague %>% group_by(part) %>% freq(love) 
```
```{r}
...
```
```{r}
plague %>% group_by(part) %>% freq(value) 

```
```{r}
plague %>% group_by(part) %>% freq(afin_sent)
```
...
```{r}
plague %>%filter(!is.na(we))%>% ggplot(aes(x = count)) + geom_histogram() + ggtitle("Change of \"WE\" Usage Throughout the Novel") + xlab("Index of Word") + theme_classic() +ggsave("We.jpg")
plague %>%filter(!is.na(love))%>% ggplot(aes(x = count)) + geom_histogram() + ggtitle("Change of \"love\" Usage Throughout the Novel") + xlab("Index of Word") + theme_classic() +  ggsave("love.jpg")
plague %>%filter(!is.na(thought))%>% ggplot(aes(x = count)) + geom_histogram() +  ggtitle("Change of \"thought\" Usage Throughout the Novel") + xlab("Index of Word") + theme_classic() +  ggsave("thought.jpg")
plague %>%filter(!is.na(selfish))%>% ggplot(aes(x = count)) + geom_histogram() + ggtitle("Change of \"selfish\" Usage Throughout the Novel") + xlab("Index of Word") + theme_classic() +  ggsave("selfish.jpg")
plague %>%filter(!is.na(exile))%>% ggplot(aes(x = count)) + geom_histogram() +  ggtitle("Change of \"exile\" Usage Throughout the Novel") + xlab("Index of Word") + theme_classic()  + ggsave("exile.jpg")
plague %>%filter(!is.na(suffer))%>% ggplot(aes(x = count)) + geom_histogram() +  ggtitle("Change of \"suffer\" Usage Throughout the Novel") + xlab("Index of Word") + theme_classic() + ggsave("suffer.jpg")
plague %>%filter(!is.na(anxiety))%>% ggplot(aes(x = count)) + geom_histogram() +  ggtitle("Change of \"anxiety\" Usage Throughout the Novel") + xlab("Index of Word") + theme_classic() + ggsave("anxiety.jpg")
plague %>%filter(!is.na(nrc_sent))%>% ggplot(aes(x = count)) + geom_histogram() + facet_wrap(~nrc_sent) + ggtitle("Change of \"sentiment\" Usage Throughout the Novel") + xlab("Index of Word") + theme_classic() + ggsave("nrc_sent.jpg")

```
```{r}
plague %>% filter(!is.na(value)) %>%ggplot(aes(x = count, y = value)) + geom_point() + geom_smooth(method='lm')
